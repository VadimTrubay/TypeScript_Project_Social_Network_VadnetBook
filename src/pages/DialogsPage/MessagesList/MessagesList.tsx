...
export const MessagesList = () => {
    ...
    const messagesEndRef = useRef<HTMLDivElement>(null); // Ссылка на конец списка
    const messagesWrapperRef = useRef<HTMLDivElement>(null); // Ссылка на контейнер сообщений
